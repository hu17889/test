...
<!-- BEGIN BODY -->
<!-- 横向菜单-->
<body  class="stock_body_center page-header-fixed <?php if(Yii::app()->params['horizontal_menu_layout'])  echo 'page-full-width';?>">

<!-- BEGIN HEADER -->
<div class="stock_body_center header navbar navbar-inverse navbar-fixed-top">
  <!-- BEGIN TOP NAVIGATION BAR -->
  <div class="header-inner">
    <!-- BEGIN LOGO -->  
    <a class="navbar-brand" href="index.html">
    <img src="/images/backadminlogo.png" alt="logo" clas="img-responsive" />
    </a>
    <!-- 横向菜单-->
