...
<form>
问卷id:<input type="text" name="qid" value="<?php echo htmlspecialchars($qid);?>"/>
<input type="submit">
</form>
...
// text name
textarray = [
    [width/8-60, height+50,"等距地点"],
    [3*width/8-80, height+80,"设备受损单位"],
    [5*width/8-80, height+50,"备用电源情况"],
    [7*width/8-80, height+80,"预计抢修时间"],
];
for(x in textarray) {
